...
client.on("message", message => {
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | **ليس لديك صلاحيات**');
      ...
      message.channel.sendMessage("", {embed: {
        title: "``` عدد الرسائل التي تم مسحها : 100``` ",
        color: 0x06DF00,
        footer: {
...
client.on('message', function(message) {
    if(message.content.startsWith('الاقتراح')) {
    ...
    client.channels.get("422760656190701569").send({embed:iiMo});
    }
});

client.on('message', message => {
   if(message.content.startsWith('تصويت')) {
message.react("❎")
message.react("✅")
}
});
...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
          ...
          client.on('message', message => {
           if (message.content.startsWith("ايدي")) {
...
var prefix = "";
   ...
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('**__ليس لديك صلاحيات__**');
            ...
            SEND_MESSAGES: true
                  ...
                  message.reply("**تم فتح قفل الشات**")
              });
                }
});
...
وش تقولوا ... إتي .. فارس الملعب

وش تقولوا ... إتي .. من عانده يتعب

قولوا معانا قولوا عاشوا المحبين

قولوا معانا قولوا على الراس والعين
...
عاشق من ضمن الملايين

وش تقولوا.... مبروك.... واستلمت الكاس

وش تقولوا.... مبروك.... من أعز الناس

الكل  صحبة جونا مهنيين

سعد الليالي دايم يا اتحاديين
...
**`,
  `**ما خبرت انسان
‏ماخبرت انسان يحب انسان ثاني 
عمره ما شافه ولا حتى ثواني
حاله اغرب من غريبه 
صار معشوقه وحبيبه 
فهموني ماني مستوعب هماني

‏ليتها لمحه فنظره فابتسامه
كان اقنعني في حبه وغرامه 
اشرحو له ما هي صح 
بكره يشكي في قلبه جرح
وش يفيد الصوت من بعد الندامه


**`,
  `**ضحاياك
ضحاياك قلبي والقلوب الشقاويه
أبد لا يهمك .. مقدي فيه ما جاله
عشقت اللي سويته ألا لعنبو حيه
ألا لعنبو حي اللي قيدني بحباله

أخذني وأثاري الشوق في العين ماريه
لعب بي وأنا اللي رايح فيه بوصاله
كثر ما يمر البال طيفه وأنا أتهيا
أخاف أفقده والعين ف البعد هماله

أخذني يا وجه الله غرام ولا زيه
غرام يقول الزود عندي وأنا أسعاله
أنا رحّت به يا ناس مليون في الميه
ألا لعنبو حي اللي قيدني بحباله


**`,
  `**ياحبيبي ما انت الاول
يا حبيبي ما انت الاول ليه قلبك غيروه
لو تبيني كان تسأل واللي يسأل ما يتوه

لا تعذر بالمسافه ما انت ع الكذب مغصوب
البعد مو بالمسافه البعد بعد القلوب
يوم كنت اول تبيني ما تفارق لحظه عيني
قبل ما اندهلك تجاوب قبل اناديلك تيجي 
 

لا تقول ظروفي صعبه مين هو ما عنده ظروف
لو بقلبك لي محبه جيت لو عندك ظروف 
يوم كنت اول تبيني ما تفارق لحظه عيني
قبل ما اندهلك تجاوب قبل اناديلك تيجي

**`,
  `**انا الملك
انا الملك بالحب والذوق والصد ..
وانا الحليم اللي على الجرح صبار ..
عند الوله مالي محاذير او حد ..
ومن صدني قفيت واهديته ازهار ..
وحدي بحزني مالي وصفٍ ولا ند ..
وافراحي تعرفني انا ابنها البار ..
حنون ومن طبعي وابيّح السد ..
واللي ظلمني عنه انا اقدم اعذار ..
 

احلم وانا نايم بعصفور غرد ..
كنه يناجيني على جال انهار ..
وافز انادي بس هالحلم ما رد ..
احلامي القاها كتابات جدران ..
وانا الملك ..
 

حزني من اللي شاف من روعته شك ..
قال انت احسن مني وش باقي ما صار ..
قلت انتظر ما شفت دمعي على الخد ..
قال الا بمشي عنه ديار ..
هذي حياتي حلم تتنفس الورد ..
وحياتي اعصار في جوف اعصار ..
بس الملك لا دارت وحصحص الجد ..
يبقى ملك والغير يادوب تذكار ..

**`,
  `**خميس
خميس ومالي خلق أزعل .. مهما تستفزوني
خميس ومالي خلق أزعل .. أنا فوق السحاب هناك شوفوني
بأجل للأحد كل شي وبستانس أبستانس
إلين اليوم يصبح أول أول أمس وأبستانس

أنا سيد المسا .. والليل عنواني
أنا وحدي ولا .. غيري أحد ثاني
أنا العازم .. أنا المعزوم
أنا اللازم .. وأنا الملزوم
أنا الأبدى أنا الأولى ولا مني أهم اليوم
خميس اليوم

أنا فيني حزن .. واليوم أبا أهينه
أنا فيني ألم .. بلقاه بس وينه
أبضحك .. لين يبكي الهم
أبامرني .. وألبي سم
أبنسى كل شي وأرمي ورى ظهري ولا أهتم
كفاني هم

**`,
  `**سقى الله
سقى الله زمان راح ولا ظنتي بيعود
زمان الحبيب اللي خذا قلبي واشقاني
حبيب تمنيته معي دايم موجود
ما اشوف انا غيره تقول كنه اعماني

عطاه الذي سوى زين بلا اي حدود
يمشي مع العالم بالسير وحداني
لامن تبسم لي لمحت رموشه السود
ضاع الحكي مني وتلعثم لساني

حسبي على من حال بيني وبينه كود
رب البلا يبلاه دامه تبلاني
الا يا زمان اغبر الا يا زمان جحود
يا مفرق الخلان الله على الجاني

**`,
  `**يهمك امري
يهمك أمري ما ظنيت أنا أظنك خلي إحساس
سنين أتحمل وساكت ولا كلمتك وعاتبت
ولكن فاض بي ومليت ولا هزك شديد الباس
تعبت إهمالك الواضح وضيق صدري مر الكبت

تعال نقلب الماضي تذكر لهفة الأنفاس
تلاقي نفسك بنفسك بعيد إنتا ولو قربت
من اللي قالك إني أنا أيوب يا إبن الناس
ترى صبري وصل حده وانا من طول صبري شبت

حبيب الأمس سامحني تعبت المر وسط الكاس
تعبت أغيب عن بالك وأنا عن بالي ما قد غبت
ولكن بحسم الموقف ولو غصب علي لا باس
مع انك اغلى ما عندي .. انا منك وعنك تبت
...
عن قِصة هوانا ..
لا أنتِ ولا أنا ماجبنا لأحد سيره ..
ولا خنَّا الأمانه ..
وإذن كيف .. عِرفوا النَّاس عن قِصة هوانا ..

وين المفر .. من كلام النَّاس
من عيون البشر ..
رغم الحذر .. إلا إن السِّر ماأسرع ماأنتشر ..
فكَّرنا بإستغراب .. وأنهزَّت الأعصاب
مين الَّلي ودَّا وجاب ..
وسرَّب الخبر ..
لا أنتِ ولا أنا ماجبنا لأحد سيره ..
ولا خنَّا الأمانه ..
وإذن كيف .. عِرفوا النَّاس عن قِصة هوانا ..

فكِّر معايا أيش نقول ..
فكَّر معي بأي الحلول ..
لازم نرد ..
وننفي الخبر مِن أوِّله ..
يانعترف .. وننهي كِل المسأله ..
ويبقى السَّؤال .. نفس السَّؤال ..
هِناك باقي مشكله ..
لا أنتِ ولا أنا ماجبنا لأحد سيره ..
ولاخنَّا الأمانه ..
وإذن كيف .. عِرفوا النَّاس عن قِصة هوانا ..
...
**`,
 ...
 if (msg.content.startsWith('اغاني')) {

  var Secret = new Discord.RichEmbed()
  .setColor('RANDOM')
 .setDescription(`${SecreT[Math.floor(Math.random() * SecreT.length)]}`)
  msg.channel.sendEmbed(Secret);
   msg.react("..")
  }
});
...
message.member.removeRole(message.guild.roles.find("name", "100"));
   ...
   .setDescription(`تم مسح اللون بنجاح`)
...
client.on('message', message => {
 if (message.content === "rainbow") {
  ...
  message.member.addRole(message.guild.roles.find("name", "rainbow"));
 
 }
 });
 
client.on('message', message => {
 if (message.content === "dirainbow") {
     if(!message.channel.guild) return;
         message.delete()

  message.member.removeRole(message.guild.roles.find("name", "rainbow"));
  ...
  client.on("message", message => {
    ...
    return;
                ...
                const mo5tar = new Discord.RichEmbed()
            ...
            .setColor('RANDOM')  
            message.channel.sendEmbed(mo5tar);  
            message.channel.send('لا / نعم');
              let sss = message.author;
              const collector = new Discord.MessageCollector(message.channel, m => sss === sss, { time: 10000 });
  collector.on('collect', message => {
                ...
                m.send(`${m}`,{embed: bc});
                    ...
                    message.reply('لن يتم ارسال الرسالة');
                  } return;
...
message.channel.sendMessage('فقط لريبل هذه الخاصية ');
...
const SecreT = [
  ...
  "**انتهى زمن الفروسية ، لم تنقرض الخيول بل انقر�������������� الفرسان**.", 
 ...
 client.on('message', msg => {
 if (msg.content.startsWith('خواطر')) {
...
const cuttweet = [
     ...
     'كت ت��يت ‏- كلمة لل��ُد��ع؟',
     'ك�� تويت ‏- ما الشيء الذي يُفارقك؟',
     'كت تويت ‏- ما الشيء الذي يُفارقك؟',
     'كت تويت ‏- موقف مميز فعلته مع شخص ولا يزال يذكره لك؟',
     'كت تويت ‏- أيهما ي����تصر، الكبرياء أم الحب؟',
     'كت تويت| بعد ١٠ سنين ايش بتكون ؟',
     'كت تويت ‏- مِ���� أغرب وأجمل الأسماء التي مرت عليك؟',
     ...
     '‏كت تويت|كلمة تشعر بالخجل اذا قيلت لك؟',  '‏كت تويت|جسمك اكبر من عٌمرك او العكسّ ؟!',
...
const Sra7a = [
     ...
     '**‏صراحه  |  **إذا ذهبت إلى مُظاهرة لتعترض على المشاكل المو��ودة بالدولة ما هو الشعار الذي تقوم بالهتاف والمطالبة به؟',
     '**‏صراحه  |  **ما هو اسوأ خبر سمعته بحياتك؟',
     '**‏صراحه  |  **متى آخر مرة قمت بعمل مُشكلة كبيرة وتسببت في خسائر؟',
     '**‏صراحه  |  **هل قمت بانتحال أحد الشخصيات لتكذب على من حولك؟ ',
     '**‏صراحه  |  *إذا قالوا لك قم بفعل جريمة ما، فما هي الجريمة التي سوف تختارها؟',
     '**‏صراحه  |  **هل تُتقن عملك أم تشعر بالممل؟',
     '**‏صراحه  |  **ما هي طريقة الزواج التي تُحب أن تتبِعها (الزواج الناتج عن حب أم الزواج التقليدي)؟',
     '**‏صراحه  |  ** كيف تتخلص من تعلق قلبك وفكرك بشخص آخر؟', '**‏صراحه  |  **متى يضيق خلقك؟',
     ...
     if (message.author.bot) return
          message.delete();
            let args = message.content.split(' ').slice(1);
                ...
                if (virusname < 1) {
                    return message.channel.send('منشن الشخص الذي تريد مني تهكيره او تلغيمه !!');
                }
            ...
            setTimeout(function() {
              message.channel.send('شكرا لك الآن لدي الرمز الخاص بك')
          }, 33000)
          });
        }
})    
...
client.on('message', message => {
 if (message.content.includes('discord.gg')){      //شيل المسافه
    ...
    message.channel.send('ممنوع نشر روابط السيرفرات هنا <@' + message.author.id + '>')
    message.delete() 
